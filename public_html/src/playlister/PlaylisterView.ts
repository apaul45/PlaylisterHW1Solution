...
export default class PlaylisterView {
    controller: PlaylisterController;
    ...
    */
    setController(initController: any) {
    ...
    */
    appendListToView(newList: Playlist) {
    ...
    */
    updateToolbarButtons(model: PlaylisterModel) {
        let tps = model.tps;
    ...
    */
    updateStatusBar(model: PlaylisterModel) {
