...
export default class PlaylisterController {
    ...
    listToDeleteIndex: number;

    constructor() { 
        this.model = new PlaylisterModel();
        this.listToDeleteIndex = -1;
    }
    ...
    */
    setModel(initModel: PlaylisterModel) {
    ...
    */
    initModalHandlers() {
        ...
        document.getElementById("edit-song-confirm-button")!.onmousedown = (event) => {
            ...
            let editedSong = {
                title: (<HTMLInputElement>document.getElementById("edit-song-title"))!.value,
                artist: (<HTMLInputElement>document.getElementById("edit-song-artist"))!.value,
                youTubeId: (<HTMLInputElement>document.getElementById("edit-yt-id"))!.value
            }
    ...
    */
    registerListSelectHandlers(id: number) {
        ...
        document.getElementById("list-card-text-" + id)!.ondblclick = (event) => {
            ...
            textInput.onkeydown = (event) => {
                if (event.key === 'Enter') {
                    this.model.renameCurrentList((<HTMLInputElement>event.target!).value, id);
                    this.model.refreshToolbar();
                }
            }
    ...
    */
    registerItemHandlers() {
        ...
        for (let i = 0; i < this.model.getPlaylistSize(); i++) {
            ...
            card!.ondragstart = (event) => {
                ...
                (<any>event.dataTransfer!).setData("from-id", i);
            }
            ...
            card!.ondrop = (event) => {
                ...
                let toIndex = Number.parseInt((<HTMLElement>event.target!).id.split("-")[2]) - 1;
            ...
            card!.ondblclick = (event) => {
                ...
                (<HTMLInputElement>document.getElementById("edit-song-title"))!.value = song.title;
                (<HTMLInputElement>document.getElementById("edit-song-artist"))!.value = song.artist;
                (<HTMLInputElement>document.getElementById("edit-yt-id"))!.value = song.youTubeId;
    ...
    /*
        ...
        to other controls.
    */
    ignoreParentClick(event: MouseEvent) {
